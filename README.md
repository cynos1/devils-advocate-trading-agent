...
Devil's Advocate is an autonomous paper-trading agent built for the Alpaca AI Trading Agents Hackathon. Instead of trusting a single AI-generated trade, the system uses a separate adversarial AI role to challenge the proposal before deterministic code decides what is actually allowed to execute.

> **Models make judgments. Code controls authority.**

## Explore the project

- [Live Project Website](https://cynos1.github.io/devils-advocate-trading-agent/)
- [Judge Report](https://cynos1.github.io/devils-advocate-trading-agent/judge-report.html)
- [Decision Traces](https://cynos1.github.io/devils-advocate-trading-agent/decision-trace.html)
- [GitHub Repository](https://github.com/cynos1/devils-advocate-trading-agent)

## How it works

1. Market / portfolio state is collected from Alpaca.
2. A proposer AI role selects an options trade and explains its reasoning.
3. An adversarial AI role acts as the Devil's Advocate, returning a failure mode and severity score.
...
The proposer and adversarial roles are implemented as separate agent roles with different objectives. Deterministic code retains final execution authority.
...
The calibration results suggest that the adversarial role is more reliable at identifying that intervention is needed than at perfectly naming the underlying failure mode.

## Deterministic risk gates

Code enforces approved underlyings, coverage/collateral, maximum contracts per trade, modeled-downside constraints, options exposure limits, daily trade cap, daily drawdown halt, kill switch, and fail-closed state handling.
...
The key distinction is that model reasoning can influence a recommendation, but only deterministic code can grant execution authority.
...
- [Interactive Judge Report](https://cynos1.github.io/devils-advocate-trading-agent/judge-report.html)
- [Visual Decision Traces](https://cynos1.github.io/devils-advocate-trading-agent/decision-trace.html)
